...
import { loginSchema, type LoginFormData } from "@/lib/auth/domain/schemas";
        ...
        <div className="relative z-10 flex flex-col justify-between h-full">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/70 text-lg">
              La mejor aplicación para organizar y gestionar tus contactos de manera fácil y segura.
            </p>
          </div>
